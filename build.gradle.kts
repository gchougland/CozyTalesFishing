 ...
 * 1. environment variable {@code COZYTALESFISHING_HSTATS_MOD_UUID}
...
val hstatsModUuid: Provider<String> =
    providers
        .environmentVariable("COZYTALESFISHING_HSTATS_MOD_UUID")
        .map { it.trim() }
        ...
        doLast {
            ...
            val escaped =
                uuid
                    .replace("\\", "\\\\")
                    .replace("\"", "\\\"")
            val pkgDir = outDir.get().asFile.resolve("com/hexvane/cozytalefishing/generated")
            pkgDir.mkdirs()
            pkgDir.resolve("HstatsBuildMetadata.java").writeText(
                """
                package com.hexvane.cozytalefishing.generated;
                ...
                public final class HstatsBuildMetadata {
                    ...
                    /** Mod UUID from build-time env {@code COZYTALESFISHING_HSTATS_MOD_UUID} or Gradle {@code hstats_mod_uuid}; empty when unset. */
